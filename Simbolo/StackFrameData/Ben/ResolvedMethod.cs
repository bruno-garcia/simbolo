...
namespace System.Diagnostics
{
    internal class ResolvedMethod
    {
        ...
        public IEnumerable<ResolvedParameter> Parameters { get; set; } = Enumerable.Empty<ResolvedParameter>();

        public IEnumerable<ResolvedParameter> SubMethodParameters { get; set; } = Enumerable.Empty<ResolvedParameter>();
